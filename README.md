...
This repository contains the R scripts used throughout the research workflow to \*\*develop and validate a statistical framework for the analysis of ranking data in quantitative genetics\*\*.
...
The raw data used in the study are publicly available on Zenodo:
...
The statistical framework and results are described in the peer-reviewed article:
