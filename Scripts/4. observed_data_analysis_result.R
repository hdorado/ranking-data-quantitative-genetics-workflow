...
# The actual ranking reported accounts for the analysis.
...
nams <- list.files('Results/Observed_data_outputs/')

observed_dataset <- lapply(list.files('Results/Observed_data_outputs/',full.names = T),readRDS)
...
ggsave('Results/cassava_genotypic_means.png',ga,height = 8,width = 9.5)
...
ggsave('Results/groundnut_genotypic_means.png',ga,height = 8,width = 9.5)
...
ggsave('Results/maize_genotypic_means.png',ga,height = 8,width = 9.5)
